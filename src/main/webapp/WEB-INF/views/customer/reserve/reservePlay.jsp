	...
	<div id="content">
		...
		<div class="container" >
			<form class="needs-validation" name="joinform"novalidate>
				...
				<div class="card-group" style="text-align:center; margin:0 auto; border-color: red; margin-left:90px; margin-bottom:15px;">
					<div class="card" >
						<div class="card-body">
							<h4 class="card-title">회원번호</h4>
							<p class="card-text" style="color:blue;  font-size:25px;">${MemberNo}</p>
						</div>
					...
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">검사항목 (* 기초항목필수)</h4>
				...
				<!-- 달력 시작 -->
				<div style="margin-rignt:10px; margin-top:20px; float:left; width:60%; border-right: 3px solid black;">
					<table id="calendar" align="center" >

						<tr style="border-bottom: 3px solid black;">
							<th align="center"><label onclick="prevCalendar()"> ◀ </label></td>
							<td colspan="5" align="center" id="calendarTitle" style="font-size:45px;">yyyy년  &nbsp;&nbsp;&nbsp;&nbsp;m월</td>
							<th align="center"><label onclick="nextCalendar()"> ▶ </label></td>
						</tr>
						<tr>
							<td align="center" style="font-size:45px;"><font color ="#F79DC2">일</td>
							<td align="center" style="font-size:45px;">월</td>
							<td align="center" style="font-size:45px;">화</td>
							<td align="center" style="font-size:45px;">수</td>
							<td align="center" style="font-size:45px;">목</td>
							<td align="center" style="font-size:45px;">금</td>
							<td align="center" style="font-size:45px;"><font color ="skyblue">토</td>
						</tr>
				...
				<div style="float:right; width:32%;">
					<input id="selectedDate" type="text" name="selectedDate" readonly="readonly" style="float:left; margin-top:50px; font-size:40px; margin-bottom:30px;">

					<div id="timeList" style="margin-top:30px; font-size:45px; margin-left:20px;">
					</div>
				</div>

				<button class="w-100 btn btn-primary btn-lg" type="button" id="reserveBtn" style="margin-top:30px;">예약하기</button>
			</form>
