			...
			<div style="padding-top: 50px; text-align: center">
				...
				<table class="table table-hover">
					...
					<c:forEach var="pm" items="${pmlist}" varStatus="status">
						<c:if test="${pm.examination != null}">
							<tr>
								<td align="center">
									<input type="hidden" name="date" value="${pm.performanceYear}/${pm.performanceMonth}">
									${pm.performanceYear}년 ${pm.performanceMonth}월
								</td>
								<td align="center">
									${pm.memberNo}
								</td>
								<td align="center">
									<input type="hidden" name="doctorName" value="${pm.name}">
									${pm.name}
								</td>
								<td align="center">
									${pm.gender}
								...
								<td align="center">
									<input type="hidden" name="examTotal" value="${pm.examTotal}">
									<fmt:formatNumber value="${pm.examTotal}" pattern="#,###원" />
								</td>
							</tr>
						</c:if>
					</c:forEach>
